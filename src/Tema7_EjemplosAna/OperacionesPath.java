...
public class OperacionesPath {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Path unPath = Path.of("/users/ericm/Desktop/prueba");
        Path otroPath = Paths.get("/users/ericm/Desktop/prueba2");

        // Obtener el nombre de un fichero y unirlo a la ruta de otro directorio
        Path unFile = Path.of("/users/ericm/Desktop/prueba/ayuda.txt");
        Path unDir = Path.of("/users/ericm/Desktop/prueba3");
        // /home/user/file.txt
