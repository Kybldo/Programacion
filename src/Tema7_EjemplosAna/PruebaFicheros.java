...
public class PruebaFicheros {
    ...
    public static void main(String[] args) {
        ...
        //CLASE FILE
        File fichero = new File("datosAnaPrueba.txt");
        ...
        } else System.out.println("Cannot be Read");

        if (f.canWrite()){

            System.out.println("Can be Write");

        } else System.out.println("Cannot be Write");
    ...
    public static void recorrerDirectorios(String ruta) {
        ...
        for (File s : lista2) {
            ...
            if (s.isFile()) System.out.println("Archivo ->  " + s.getName());
